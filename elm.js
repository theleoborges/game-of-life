...
Elm.Patterns.make = function (_elm) {
   ...
   var gliderGun = _U.list([{ctor: "_Tuple2",_0: 3,_1: 7}
                           ...
                           ,{ctor: "_Tuple2",_0: 13,_1: 7}
                           ,{ctor: "_Tuple2",_0: 13,_1: 8}
                           ,{ctor: "_Tuple2",_0: 13,_1: 9}
                           ,{ctor: "_Tuple2",_0: 14,_1: 6}
                           ,{ctor: "_Tuple2",_0: 14,_1: 10}
                           ,{ctor: "_Tuple2",_0: 15,_1: 5}
                           ,{ctor: "_Tuple2",_0: 16,_1: 5}
                           ,{ctor: "_Tuple2",_0: 15,_1: 11}
                           ,{ctor: "_Tuple2",_0: 16,_1: 11}
                           ...
                           ,{ctor: "_Tuple2",_0: 23,_1: 5}
                           ,{ctor: "_Tuple2",_0: 24,_1: 5}
                           ,{ctor: "_Tuple2",_0: 23,_1: 6}
                           ,{ctor: "_Tuple2",_0: 24,_1: 6}
                           ,{ctor: "_Tuple2",_0: 23,_1: 7}
                           ,{ctor: "_Tuple2",_0: 24,_1: 7}
                           ,{ctor: "_Tuple2",_0: 25,_1: 4}
                           ,{ctor: "_Tuple2",_0: 25,_1: 8}
                           ,{ctor: "_Tuple2",_0: 27,_1: 3}
                           ,{ctor: "_Tuple2",_0: 27,_1: 4}
                           ,{ctor: "_Tuple2",_0: 27,_1: 8}
                           ,{ctor: "_Tuple2",_0: 27,_1: 9}
                           ,{ctor: "_Tuple2",_0: 37,_1: 5}
...
Elm.Main.make = function (_elm) {
   ...
   var view = function (_p2) {
      var _p3 = _p2;
      var folder = F2(function (coord,cells) {
      ...
      return A3($Graphics$Collage.collage,800,800,A3($Set.foldr,folder,_U.list([]),_p3.livingCells));
   };
   ...
   var update = F2(function (_p10,model) {
      var folder = F2(function (coord,_p11) {
         var _p12 = _p11;
         var _p16 = _p12._1;
         var _p15 = _p12._0;
         ...
         if (_p13.ctor === "Just") {
               ...
               return {ctor: "_Tuple2"
                      ...
                      ,_1: !_U.eq(_p13._0._0.alive,_p14.alive) ? A2($List.append,_p16,A2($List._op["::"],coord,neighbouringCoords(coord))) : _p16};
            } else {
               return {ctor: "_Tuple2",_0: _p15,_1: _p16};
            }
      });
      var _p17 = A3($Set.foldr,folder,{ctor: "_Tuple2",_0: model.generation,_1: _U.list([])},model.livingCells);
      var newGen = _p17._0;
      var newLivingCells = _p17._1;
      return _U.update(model,{generation: newGen,livingCells: $Set.fromList(newLivingCells)});
   });
   ...
   var main = A2($Signal.map,view,A3($Signal.foldp,update,A2(init,100,100),$Time.fps(60)));
