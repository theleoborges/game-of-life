...
Elm.Main.make = function (_elm) {
   ...
   var cell = function (_p0) {
      ...
      A2($Graphics$Collage.filled,_p1.alive ? $Color.green : $Color.red,A2($Graphics$Collage.rect,$Basics.toFloat(_p1.width),$Basics.toFloat(_p1.height))));
   };
   var view = function (_p2) {    var _p3 = _p2;return A3($Graphics$Collage.collage,600,600,A2($List.map,cell,$Dict.values(_p3.generation)));};
   var numAliveNeighbours = F3(function (dict,_p4,cell) {
      var _p5 = _p4;
      var _p8 = _p5._1;
      var _p7 = _p5._0;
      ...
      var neighbours = _U.list([{ctor: "_Tuple2",_0: _p7 - 1,_1: _p8 - 1}
                               ...
                               ,{ctor: "_Tuple2",_0: _p7 + 1,_1: _p8}
                               ,{ctor: "_Tuple2",_0: _p7 + 1,_1: _p8 + 1}]);
      return A3($List.foldr,F2(function (status,acc) {    return status ? acc + 1 : acc;}),0,A2($List.map,livingStatus,neighbours));
   });
   var handleLivingCell = F3(function (dict,coord,cell) {
      var n = A3(numAliveNeighbours,dict,coord,cell);
   ...
   var update = F2(function (_p10,model) {    return _U.update(model,{generation: A2($Dict.map,handleCell(model.generation),model.generation)});});
   ...
   var cells$ = F2(function (rows,columns) {
      ...
      function (y) {
         return A2($List.map,
         function (x) {
            return {ctor: "_Tuple2",_0: {ctor: "_Tuple2",_0: x,_1: y},_1: A5(Cell,x * 10,y * 10,10,10,true)};
         },
         _U.range(0,columns));
      },
      _U.range(0,rows));
   ...
   var main = A2($Signal.map,view,A3($Signal.foldp,update,A2(init,10,10),$Time.fps(1)));
